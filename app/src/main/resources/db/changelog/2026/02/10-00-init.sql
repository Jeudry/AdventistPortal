...
create table user_service.users (id uuid not null, created_at timestamp(6) with time zone not null, email varchar(255) not null unique, first_name varchar(255), has_verified_email boolean not null, hashed_password varchar(255) not null, last_name varchar(255), profile_picture_url varchar(255), updated_at timestamp(6) with time zone not null, username varchar(255) not null unique, primary key (id));
