...
create table inventory_service.article_variants (id uuid not null, description TEXT, image_url varchar(255), is_active boolean not null, name varchar(255) not null, replacement_cost numeric(19,4), sku varchar(255) not null, stock integer not null, article_id uuid, primary key (id));
