...
--changeset sargon:04-02-outbox-notification
...
create table notification_service.outbox (
...
create index idx_outbox_pending on notification_service.outbox (created_at) where sent_at is null;
