...
This project is part of the [**Master Building Industry-Scale Full-Stack Kotlin Apps**](https://adventistportal.com/cmp-mobile?utm_source=github&utm_medium=readme&utm_campaign=default&cmc_strip=utm) bundle where you'll learn to build production-ready apps from scratch.
