...
fun NavGraphBuilder.authGraph(
    ...
    navigation<AuthGraphRoutes.Graph>(
        ...
        composable<AuthGraphRoutes.EmailVerification>(
            deepLinks = listOf(
                navDeepLink {
                    this.uriPattern = "https://adventistportal.com/api/auth/verify?token={token}"
                },
                navDeepLink {
                    this.uriPattern = "adventistportal://adventistportal.com/api/auth/verify?token={token}"
                },
            )
        ) {
        ...
        composable<AuthGraphRoutes.ResetPassword>(
            deepLinks = listOf(
                navDeepLink {
                    this.uriPattern = "https://adventistportal.com/api/auth/reset-password?token={token}"
                },
                navDeepLink {
                    this.uriPattern = "adventistportal://adventistportal.com/api/auth/reset-password?token={token}"
                },
            )
        ) {
            ResetPasswordRoot()
